...
YAMSAudioProcessorEditor::YAMSAudioProcessorEditor(YAMSAudioProcessor &p)
  ...
  inputVolumeAttachment =
      std::make_unique<AudioProcessorValueTreeState::SliderAttachment>(
          audioProcessor.apvts, "INPUTVOLUME", inputVolumeSlider);
  ...
  threshAttachment =
      std::make_unique<AudioProcessorValueTreeState::SliderAttachment>(
          audioProcessor.apvts, "THRESHOLD", threshKnob);
  ...
  limiterAttachment =
      std::make_unique<AudioProcessorValueTreeState::SliderAttachment>(
          audioProcessor.apvts, "LIMIT", limiterKnob);
  ...
  outputAttachment =
      std::make_unique<AudioProcessorValueTreeState::SliderAttachment>(
          audioProcessor.apvts, "OUTPUTVOLUME", outputKnob);
...
void YAMSAudioProcessorEditor::paint(juce::Graphics &g) {
  ...
  auto background = juce::ImageCache::getFromMemory(
      BinaryData::YAMS_GUI_png, BinaryData::YAMS_GUI_pngSize);
